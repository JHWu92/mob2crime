...
logging.basicConfig(filename="logs/StatMexTwHalfHrUniqCnt.log", level=level,
                    format='%(asctime)s - %(name)s - %(levelname)s - %(message)s')

# In[10]:

stat_dir = f'stats/MexTwHalfHrUniqCnt-{args.call_in_or_out}/'
if args.debugging:
    stat_dir += 'debug/'
...
agg_dir = {'in': 'stats/AggMexTwDyHalfHrUnqUsrVOZENTRANTE/', 'out': 'stats/AggMexTwDyHalfHrUnqUsrVOZ/'}
dates_in_file = {}
data_queues = {}
dates = set()
